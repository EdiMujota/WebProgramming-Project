            ...
            <div class="col-md-6">
                <div class="card bg-light" style="margin: 10px">
                    <div class="card-body">
                        <div class="row">
                            <div class="col text-center">
                                <img width="60px" src="../Images/books.png" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col text-center">
                                <h3>Your Issued Books</h3>
                                <asp:Label CssClass="badge badge-pill badge-info" Text="info about issued books date" ID="Label1" runat="server" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row">
                            <asp:GridView ID="BooksGridView" CssClass="table table-striped table-bordered table-responsive" runat="server" OnRowDataBound="BooksGridView_RowDataBound">
                            </asp:GridView>
                        </div>
